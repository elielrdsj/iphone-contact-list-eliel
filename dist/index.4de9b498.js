...
var _allcontactsJs = require("./allcontacts.js");
var _newContactsJs = require("./newContacts.js");
var _loginJs = require("./login.js");
function redirectPages() {
    const root = document.getElementById("root");
    const Router = {
        "#login": {
            component: (0, _loginJs.entrar),
            path: "#login"
        },
        "#404": {
            component: (0, _loginJs.entrar),
        ...
        "#Contacts": {
            component: (0, _allcontactsJs.Allcontacts),
            path: "#contacts"
        },
        "#NewContact": {
            component: (0, _newContactsJs.NewContact),
            path: "#newcontact"
        }
    };
    let route;
...
},{"./allcontacts.js":"8G6LC","./newContacts.js":"eNexb","./login.js":"9jZEH"}],"8G6LC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Allcontacts", ()=>Allcontacts);
var _getAllContacts = require("./getAllContacts");
const searchContacts = document.createElement("form");
const displayContacts = document.createElement("ul");
contact.setAttribute("");
const header = Headers();
const Allcontacts = async ()=>{
    const contatos1 = await (0, _getAllContacts.GetAllContacts);
    ...
    for (contato of contatos1)displayContacts.innerHTML = `
    <li>
        <div class="contatos">
...
function searchByName() {
    ...
    contatos.array.forEach((element)=>{
        ...
        if (text.toLowerCase().includes(filter)) element.display = "";
...
},{"./getAllContacts":"5PuZm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5PuZm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"eNexb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "NewContact", ()=>NewContact);
var _postContact = require("./postContact");
const header = Headers();
const createContact = document.createElement("form");
const sendForm = async (event)=>{
    event.preventDefault();
    const fd = new FormData(createContact);
    const response = await (0, _postContact.ContactPost)(fd);
    if (response === 200) window.open("#contacts", "_self");
};
...
},{"./postContact":"4DuIV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4DuIV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9jZEH":[function(require,module,exports) {
...
},{}]},["2Rsls","4pp4s"], "4pp4s", "parcelRequire3532")
